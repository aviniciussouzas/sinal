...
bashgit clone https://github.com/seu-usuario/sinal.git
cd sinal
npm install
...
Crie um novo projeto: sinal-design
...
Faça o download do arquivo .json — guarde com segurança, nunca suba para o GitHub

2.3 Criar a planilha

Crie uma nova planilha em sheets.google.com
Nome: SINAL — Radar de Disponibilidade
Na linha 1, adicione os cabeçalhos exatamente assim:

ABCDEFGHIJidnomesemananivelclientesextrasdatahoraparceiroversao

Compartilhe a planilha com o client_email do arquivo JSON baixado (permissão de Editor)
Copie o ID da planilha — é o trecho da URL entre /d/ e /edit

3. Configure as variáveis de ambiente
Crie um arquivo .env.local na raiz do projeto:
envGOOGLE_SHEETS_ID=cole_aqui_o_id_da_planilha
...
Em Environment Variables, adicione as três variáveis do .env.local
Deploy
...
Roadmap
 ...
 v1 — Check-in semanal, escala 0–5, parceiro da semana, edição única até quarta, dashboard coletivo, tema dark/light
